...
- 视频二剪与多平台分发
  - 新任务默认进入标准二剪，支持快速二剪、标准二剪 / AI 重制和原片分发
  - AI 生成开场钩子、中文解说、镜头动作、B-roll / AI 画面建议
  - 分别生成 B站、抖音和 YouTube 的标题、文案与剪辑策略
  - 来源状态采用绿 / 黄 / 红非阻塞提示，不影响脚本、粗剪与成片制作
  - 发布仍由用户确认，不提供镜像、变速、去标识等规避检测功能
- Web 管理后台
  - 任务列表、人工审核、强制上传
